        ...
        <div class="modal-content">
            ...
            <div id="errordivreg">
                <%
                    ...
                    if (msgg != null) {
                %>
                <div class="alert alert-dismissible <%=msgg.getCssStyle()%> fade show" id="successalert" role="alert">
                    <strong><div id="resptxt"><%=msgg.getContent()%></div></strong>
                    <button type="button" class="close" data-dismiss="alert"
                            aria-label="Close">
                        <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <div id="spinregister" name="spinregister" style="display:none;" class="container text-center">
                ...
                <form name="form1" action="RegisterServlet" method="post" id="form1">
                    <div class="form-group">
                        <label for="username">Name</label> <input type="text"
                                                                  ...
                                                                  name="username" />
                        <label for="firmname"> Company Name</label> <input
                            type="text" class="form-control" required id="firmname"
                            name="firmname"> 
...
<div class="modal fade " id="staticLogin" data-backdrop="static"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container text-center" name="spinlogin" style="display: none;" id="spinlogin">
                    <div class="spinner-grow" role="status">
                        <span class="sr-only"></span>
                    </div>
                </div>
                <form name="form2" action="LoginServlet" method="post" id="form2">
                    <div class="form-group">
                        <label for="useremail2">Email ID</label> <input type="text"
                                                                        class="form-control" required="true"pattern="[a-z0-9A-Z._%+-]+@[a-zA-Z0-9.-]+\.[A-Za-z]{2,}$"
                                                                        name="useremail2" id="useremail2">
                        <label for="userpassword2">Password</label> 
                        <input type="password" title="Min 8 Letter, 1 in UpperCase, 1 in LowerCase and Number "
                               pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" class="form-control" required name="userpassword2"
                               id="userpassword2"> <br>
